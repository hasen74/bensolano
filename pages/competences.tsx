...
const Competences: NextPage = () => {
  ...
  const [selectedCloud, setSelectedCloud] = useState('allskillscloud')
  ...
  useEffect(() => {
    switch (containerSize) {
      case 'back':
        ...
        setSelectedCloud('allskillscloud')
      case 'bdd':
  ...
  return (
    <>
      ...
      <main className="container">
        <Navbar />
        <div className="main">
          <div className="cliquez">
            Pour plus de détails sur une compétence et voir les projets associés, cliquez sur l'icône.
          </div>
          <div className={`competences-container ${containerSize}`}>
            ...
            <div className="competences-description-containers competences-description-cloud">
              <div className={`competences-description ${khula.className}`}>
                {selectedCloud === 'allskillscloud' && <p>Cloud</p>}
                {selectedCloud === 'azure' && <p>Azure</p>}
                {selectedCloud === 'atlas' && <p>MongoDB Atlas</p>}
              </div>
            </div>
            <div className="competences-icons-containers competences-icons-cloud">
              {selectedCloud === 'allskillscloud' && (
                <div className="icons-containers-phone">
                  <div className="description-phone">
                    <p>Cloud</p>
                  </div>
                  <div className="icons">
                    <Image
                      onClick={() => {
                        setContainerSize('cloud')
                        setTimeout(() => {
                          setSelectedCloud('azure')
                        }, 700)
                      }}
                      className="competences-img azure"
                    ...
                    <Image
                      onClick={() => {
                        setContainerSize('cloud')
                        setTimeout(() => {
                          setSelectedCloud('atlas')
                        }, 700)
                      }}
                      className="competences-img atlas"
                      src="/skills/mongodb.svg"
                      width={60}
                      height={60}
                      alt="Atlas"
              ...
              {selectedCloud !== 'allskillcloud' && (
                <SkillCard skill={selectedCloud} setContainerSize={setContainerSize} setSelected={setSelectedCloud} />
              )}
            </div>
